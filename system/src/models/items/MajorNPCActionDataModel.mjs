 ...
 * @property {'-'|'might'|'quickness'|'insight'|'resolve'} skillTest.attribute
 *           Attribute used for the skill test.
 * @property {'-'|'fight'|'move'|'operate'|'sneak'|'study'|'survive'|'talk'} skillTest.skill
 *           Skill used for the skill test.
