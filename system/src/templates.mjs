...
export default async function registerTemplates() {
	...
	const partials = [
		...
		"systems/dreams-and-machines/templates/actor/_partials/header.hbs",
		"systems/dreams-and-machines/templates/actor/_partials/skills.hbs",
		"systems/dreams-and-machines/templates/actor/_shared-partials/description-tab.hbs",
		"systems/dreams-and-machines/templates/actor/_shared-partials/source-tab.hbs",
