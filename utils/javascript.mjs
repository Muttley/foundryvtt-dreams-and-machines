...
const LINT_SRC_PATHS = ["./system/dreams-and-machines.mjs", "./system/src/"];

const BUILD_SRC_PATH = "./system/dreams-and-machines.mjs";
const BUILD_DST_PATH = "./system/dreams-and-machines-compiled.mjs";
